...
set_property PACKAGE_PIN V16 [get_ports {op_type}]
	set_property IOSTANDARD LVCMOS33 [get_ports {op_type}]
set_property PACKAGE_PIN W16 [get_ports {sign2}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sign2}]
set_property PACKAGE_PIN W17 [get_ports {sign1}]
	set_property IOSTANDARD LVCMOS33 [get_ports {sign1}]
set_property PACKAGE_PIN W15 [get_ports {number1}]
	set_property IOSTANDARD LVCMOS33 [get_ports {number1}]
...
set_property PACKAGE_PIN W3 [get_ports {currentDigit[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {currentDigit[0]}]
set_property PACKAGE_PIN U3 [get_ports {currentDigit[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {currentDigit[1]}]
set_property PACKAGE_PIN P3 [get_ports {currentDigit[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {currentDigit[2]}]
set_property PACKAGE_PIN N3 [get_ports {currentDigit[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {currentDigit[3]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports moveUpDown]
	set_property IOSTANDARD LVCMOS33 [get_ports moveUpDown]
#set_property PACKAGE_PIN T18 [get_ports btnU]
	#set_property IOSTANDARD LVCMOS33 [get_ports btnU]
#set_property PACKAGE_PIN W19 [get_ports btnL]
	#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
set_property PACKAGE_PIN T17 [get_ports nextDigit]
	set_property IOSTANDARD LVCMOS33 [get_ports nextDigit]
set_property PACKAGE_PIN U17 [get_ports decimalPointMover]
	set_property IOSTANDARD LVCMOS33 [get_ports decimalPointMover]
